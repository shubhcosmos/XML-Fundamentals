  ...
  public class XDocModifyViewModel : CommonBase
  {
      ...
      XDocument doc =
        new XDocument(
          ...
          new XElement("Customers"));
            doc = new XDocument(new XElement("Customers" , new XElement("Customer")));
    ...
    public void Update()
    {
      ...
      XDocument doc = XDocument.Parse(xml);
            ...
            //var customer = doc.Element("Customer").Elements("Cutomer")                
            //   .Where(x => x.Element("CustomerID").Value == "2").FirstOrDefault();

            XElement customer = doc.Descendants("Customer").Where(x=> x.Element("CustomerID").Value == "2").FirstOrDefault();
